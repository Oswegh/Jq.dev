    ...
    <section id="about" className="py-24 max-w-7xl mx-auto px-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        <div>
          ...
          <div className={`space-y-4 leading-8 jetbrains-mono ${isDark ? 'text-white/70' : 'text-black/70'}`}>
            <p>
            ...
            {/* Adding a personal, non-AI touch */}
        ...
        {/* Right Column: The "Status" Card (Matches your Hero card) */}
